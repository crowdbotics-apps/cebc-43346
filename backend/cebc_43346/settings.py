"""
Django settings for cebc_43346 project.
...
WSGI_APPLICATION = 'cebc_43346.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cebc_43346 API",
    "DESCRIPTION": "API documentation for cebc_43346 App",
    "VERSION": "v1",
}
